    ...
    try {
        ...
        if (action === 'add' && bienvenidaActivada.includes(id)) {
            ...
            for (let participant of participants) {
                ...
                const mensajePersonalizado = mensajesBienvenida[id] || "¡Bienvenido(a) al grupo!"; // Mensaje configurado o uno por defecto
...
> https://whatsapp.com/channel/0029Vb26b7jHrDZi3EeWwq1z
...
case "harem": {
    ...
    enviar(`🌸 *${targetName} Harem en este grupo:*\n\n${haremList}`);
